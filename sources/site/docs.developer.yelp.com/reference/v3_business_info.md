# Source: https://docs.developer.yelp.com/reference/v3_business_info
...
> ## 📘
> 
> To API to enable consumer experience, visit [Yelp Places API](https://docs.developer.yelp.com/docs/fusion-intro) to learn more. If to use it for internal analytics & insights, please go to [Yelp Insights API](https://docs.developer.yelp.com/business.yelp.com/data/products/insights-api/) to learn more.
