# Source: https://docs.developer.yelp.com/reference/get_daily_reports_v3
...
The Report ID from [create\_daily\_reports\_v3](https://docs.developer.yelp.com/reference/create_daily_reports_v3).
